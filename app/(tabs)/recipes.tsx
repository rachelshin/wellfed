...
export default function RecipesTab() {
  ...
  return (
    <View style={s.root}>
      <HeroHeader eyebrow="What can you make?" title="Recipes" />
      ...
      >
          ...
          >
            {aiLoading ? (
              ...
              <Text style={s.generateBtnText}>
                {aiRecipes.length > 0 ? 'Regenerate' : 'Generate recipes'}
              </Text>
            )}
          </TouchableOpacity>
        )}
        ...
        {!aiLoading && aiRecipes.length === 0 && hasApiKey && !aiError && pantryCount > 0 && (
          <View style={s.empty}>
            ...
            <Text style={s.emptySub}>
              Tap "Generate recipes" and Claude will suggest 5 personalised recipes from your {pantryCount} pantry items.
            </Text>
          </View>
        )}
...
const s = StyleSheet.create({
  ...
  closeBtn: {
    backgroundColor: theme.textDark, borderRadius: 16, padding: 18, alignItems: 'center', marginTop: 24,
  },
